...
<template>
  ...
  <div class="product-img">
    ...
    <div class="product-action d-flex justify-content-center clearfix">
      ...
      <span class="icon-card cursor-pointer"  title="Quick View" @click.stop="emits('openModal', card)"><i
          class="zmdi zmdi-zoom-in"></i></span>
      <span class="icon-card cursor-pointer"   title="Compare"><i
          class="zmdi zmdi-refresh"></i></span>
      <span class="icon-card cursor-pointer" @click.stop="useAddCart(card)" title="Add To Cart"><i
